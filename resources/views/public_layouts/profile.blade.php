...
<div class="card margin-jumbotron">
    ...
    <div class="card-body">
        ...
        {!! Form::open(['action' => 'PublicController@update_profile', 'method' => 'POST']) !!}
        <div class="md-form">
            <label>Username</label>
            <input name="user_name" type="text" class="form-control" required value="{{ $user->user_name }}" maxlength="25" minlength="8" required>
        </div>
        <br>
        ...
        <div class="md-form row">
            <div class="col-sm-12 col-md-4">
                ...
                <select name="gender" type="text" class="form-control selectpicker" required>
...
<div class="modal fade" id="change_password" tabindex="-1" role="dialog" aria-labelledby="change_password_Label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-exclamation-circle"></i> Change Password</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
            </div>
            {!! Form::open(['action' => 'PublicController@change_password', 'method' => 'POST']) !!}
